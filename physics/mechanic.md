...
<table>
    ...
    <tr>
        <td rowspan='3'> 开普勒行星运动定律 </td>
        <td> 行星运动轨迹都是椭圆，太阳在一个焦点上 </td>
        <td rowspan='3'> 单选、案例分析题、教学设计题 </td>
    </tr>
    <tr>
        <td> 行星与太阳的连线扫过的面积 </td>
    ...
    <tr>
        <td> 公转周期的二次方和半长轴的三次方的比值为常数 </td>
    </tr>
    <tr>
        <td rowspan='4'> 万有引力定律 </td>
        <td> 万有引力定律的内容 </td>
        <td > 单选、案例分析题、教学设计题 </td>
    </tr>
    <tr>
...
- $F=G\frac{m_1m_2}{r^2}$
- 万有引力提供向心力，推导线速度、角速度、和周期
- 一般认为万有引力等于重力，但是有些题目会特殊讨论（两极和赤道）。

## 双星问题

角速度 $\omega$ 一样, 质量与运动半径成反比，即 $\frac{m_1}{m_2}=\frac{r_2}{r_1}$
...
通常和运动学相关联，分析各种力做功情况，然后根据 $E=\frac{1}{2}mv^2$ 分析运动状态。
...
如果一个系统不受外力，或者外力和为零，这个系统的总动量保持不变。